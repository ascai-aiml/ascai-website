...
/**
 * AboutSection component — Displays the "About Us" section with animations,
 * binary background, and mission/vision content.
 *
...
export function AboutSection() {
  ...
  // Track client-side rendering to avoid hydration mismatches
  ...
  const staticBinaryPattern = Array.from(
    { length: 30 },
    () =>
      "1010110010101101011010010110101101001011010110100101101011010010110101101001011"
  );
    ...
    >
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10 max-w-7xl">
        ...
        <div className="text-center mb-16 scroll-animate">
          ...
          <h2 className="text-4xl md:text-6xl font-orbitron font-bold mb-8 text-white">
            WHO WE ARE
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="border-2 border-purple-500/40 p-8 bg-black/60 backdrop-blur-sm scroll-animate hover:glow-purple transition-all duration-300 rounded-lg">
            <h3 className="text-2xl md:text-3xl font-orbitron text-purple-400 mb-6">
              OUR MISSION
            </h3>
            <p className="text-gray-300 font-rajdhani text-lg leading-relaxed">
              Foster innovation, research, and collaboration in AI while
              building a community of passionate learners and future tech
              leaders.
            </p>
          </div>
          ...
          <div className="border-2 border-indigo-500/40 p-8 bg-black/60 backdrop-blur-sm scroll-animate hover:glow-indigo transition-all duration-300 rounded-lg">
            <h3 className="text-2xl md:text-3xl font-orbitron text-indigo-400 mb-6">
              OUR VISION
            </h3>
            <p className="text-gray-300 font-rajdhani text-lg leading-relaxed">
              Be the leading student organization bridging academic learning and
              industry applications in AI and ML technologies.
            </p>
          </div>
        </div>
        ...
        {/* What We Do Section */}
        <div className="text-center mb-16 scroll-animate">
          <h3 className="text-3xl md:text-4xl font-orbitron font-bold mb-12 text-white">
            WHAT WE DO
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center border-2 border-purple-500/30 p-8 bg-black/40 backdrop-blur-sm hover:glow-purple transition-all duration-300 rounded-lg">
              <h4 className="text-xl md:text-2xl font-orbitron text-purple-400 mb-6">
                WORKSHOPS
              </h4>
              <p className="text-gray-300 font-rajdhani text-lg leading-relaxed">
                Hands-on learning sessions covering latest AI/ML technologies
                and frameworks.
              </p>
            </div>
            <div className="text-center border-2 border-indigo-500/30 p-8 bg-black/40 backdrop-blur-sm hover:glow-indigo transition-all duration-300 rounded-lg">
              <h4 className="text-xl md:text-2xl font-orbitron text-indigo-400 mb-6">
                COMPETITIONS
              </h4>
              <p className="text-gray-300 font-rajdhani text-lg leading-relaxed">
                Organizing hackathons and coding competitions to challenge and
                inspire students.
              </p>
            </div>
            <div className="text-center border-2 border-cyan-500/30 p-8 bg-black/40 backdrop-blur-sm hover:glow-cyan transition-all duration-300 rounded-lg">
              <h4 className="text-xl md:text-2xl font-orbitron text-cyan-400 mb-6">
                RESEARCH
              </h4>
              <p className="text-gray-300 font-rajdhani text-lg leading-relaxed">
                Supporting student research projects and connecting with
                industry mentors.
              </p>
            </div>
          </div>
